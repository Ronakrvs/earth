...
import { Leaf, Sun, Droplets, Heart, Users, Award, MapPin, Calendar, Sprout, Camera, Shield, ArrowRight } from "lucide-react"
...
export const metadata: Metadata = {
  title: "About Our Organic Moringa Farm in Udaipur, Rajasthan | Shigruvedas",
  description: "Learn about our 7+ acre certified organic moringa farm. 10,000+ trees, chemical-free farming, and premium nutrition from Earth to Wellness. Direct from Udaipur.",
  keywords: ["organic moringa Rajasthan", "moringa farm Udaipur", "shigruvedas story", "sustainable farming India"],
}
...
export default function AboutPage() {
  ...
  const jsonLd = {
    ...
    "description": "Certified organic moringa farm in Rajasthan with 10,000+ trees and chemical-free farming. Premium moringa products direct from our farm to your wellness.",
      ...
      "itemListElement": [
        {
          ...
          "itemOffered": {
            ...
            "description": "Pure stone-ground moringa powder."
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            ...
            "description": "Freshly harvested organic moringa leaves."
          }
        }
      ]
    }

      ...
      <section className="container mx-auto px-4 py-10 lg:py-16">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight mb-4 text-orange-900">
              {recipe.name}
            </h1>
            ...
            <div className="bg-green-50 border border-green-100 rounded-2xl p-5 mb-8">
              ...
              <p className="text-green-700 leading-relaxed text-sm">
                This recipe is enhanced with Shigruvedas Organic Moringa Powder. It adds iron, vitamins, and antioxidants without changing the core flavor!
              </p>
            </div>
